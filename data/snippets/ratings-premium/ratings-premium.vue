...
<div class="main-content">
  ...
  <header class="topbar">
    ...
    <div class="topbar-actions">
      <button class="add-btn" onclick="rateAllFive()"><i class="fa-solid fa-star"></i> Max Ratings</button>
      <button class="collection-btn" onclick="resetAllRatings()"><i class="fa-solid fa-rotate-left"></i> Reset All</button>
  ...
  <section class="hero">
    <div class="hero-left">
      <div class="breadcrumb">Home &gt; Rating Indicators</div>
      ...
      <div class="hero-tags">
        <span><i class="fa-solid fa-star-half-stroke"></i> Elastic Hover</span>
        <span><i class="fa-solid fa-face-smile"></i> Neon Emojis</span>
        <span><i class="fa-solid fa-window-restore"></i> Clean Structure</span>
      </div>
    </div>

    <!-- Hero Rating Preview Animation -->
    <div class="hero-preview">
      <div class="hero-rating-demo">
        ...
        <span class="demo-label">4.8 / 5.0 Rating</span>
      </div>
    </div>
  </section>
  ...
  <section class="filters">
    <button class="active" onclick="filterCategory('all', this)">All Ratings</button>
  ...
  <!-- SHOWROOM GRID -->
  <div class="notification-grid" id="ratingsGrid">

    <!-- 1. STAR RATING COMPONENT -->
    <div class="component-card" data-category="stars">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          
          <!-- Interactive Render -->
          <div class="premium-star-rating">
            <div class="stars-row" id="classicStars">
              <i class="fa-regular fa-star" data-rating="1" onclick="setClassicRating(1)"></i>
              <i class="fa-regular fa-star" data-rating="2" onclick="setClassicRating(2)"></i>
              <i class="fa-regular fa-star" data-rating="3" onclick="setClassicRating(3)"></i>
              <i class="fa-regular fa-star" data-rating="4" onclick="setClassicRating(4)"></i>
              <i class="fa-regular fa-star" data-rating="5" onclick="setClassicRating(5)"></i>
            </div>
            <span class="rating-descriptor" id="classicLabel">Select your rating</span>
          </div>
      ...
      <pre class="code-block" id="codeS" style="display:none;"><code>&lt;div class="premium-star-rating"&gt;
  &lt;div class="stars-row"&gt;
    &lt;i class="fa-regular fa-star"&gt;&lt;/i&gt;
    &lt;i class="fa-regular fa-star"&gt;&lt;/i&gt;
    &lt;i class="fa-regular fa-star"&gt;&lt;/i&gt;
  &lt;/div&gt;
  &lt;span class="rating-descriptor"&gt;Good&lt;/span&gt;
&lt;/div&gt;</code></pre>
    </div>

    <!-- 2. EMOJI RATING SELECTOR -->
    <div class="component-card" data-category="emojis">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          
          <!-- Interactive Render -->
          <div class="premium-emoji-rating">
            <div class="emojis-row">
              <div class="emoji-node" data-emoji="1" onclick="setEmojiRating(1, 'Terrible!')">😠</div>
              <div class="emoji-node" data-emoji="2" onclick="setEmojiRating(2, 'Sad!')">😢</div>
              <div class="emoji-node" data-emoji="3" onclick="setEmojiRating(3, 'Okay!')">😐</div>
              <div class="emoji-node" data-emoji="4" onclick="setEmojiRating(4, 'Happy!')">🙂</div>
              <div class="emoji-node" data-emoji="5" onclick="setEmojiRating(5, 'Love it!')">😍</div>
            </div>
            <span class="emoji-label" id="emojiLabel">How do you feel?</span>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeE', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeE', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeE" style="display:none;"><code>&lt;div class="premium-emoji-rating"&gt;
  &lt;div class="emojis-row"&gt;
    &lt;div class="emoji-node active"&gt;😍&lt;/div&gt;
    &lt;div class="emoji-node"&gt;🙂&lt;/div&gt;
  &lt;/div&gt;
  &lt;span class="emoji-label"&gt;Love it!&lt;/span&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="cards">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-review-card" onclick="refillBars()">
            <div class="review-top">
              <div class="review-score-block">
                <span class="big-score">4.8</span>
                <span class="total-reviews">out of 5.0</span>
              </div>
            ...
            <div class="review-bars-grid">
              <div class="review-bar-row">
                <span class="row-star-label">5 <i class="fa-solid fa-star"></i></span>
                <div class="review-bar-track">
                  <div class="review-bar-fill gold" id="rFill5" style="width: 80%;"></div>
                </div>
                <span class="row-star-val">80%</span>
              </div>
              <div class="review-bar-row">
                <span class="row-star-label">4 <i class="fa-solid fa-star"></i></span>
                <div class="review-bar-track">
                  <div class="review-bar-fill gold" id="rFill4" style="width: 15%;"></div>
                </div>
                <span class="row-star-val">15%</span>
              </div>
              <div class="review-bar-row">
                <span class="row-star-label">3 <i class="fa-solid fa-star"></i></span>
                <div class="review-bar-track">
                  <div class="review-bar-fill gold" id="rFill3" style="width: 3%;"></div>
                </div>
                <span class="row-star-val">3%</span>
              </div>
            </div>
            <span class="review-card-tip"><i class="fa-solid fa-wand-magic-sparkles"></i> Click Card to Reset Bars</span>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeR', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeR', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeR" style="display:none;"><code>&lt;div class="premium-review-card"&gt;
  &lt;div class="review-top"&gt;
    &lt;span class="big-score"&gt;4.8&lt;/span&gt;
  &lt;/div&gt;
  &lt;div class="review-bars-grid"&gt;
    &lt;div class="review-bar-row"&gt;
      &lt;div class="review-bar-track"&gt;
        &lt;div class="review-bar-fill gold" style="width: 80%;"&gt;&lt;/div&gt;
      &lt;/div&gt;
    &lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="circular">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-circular-rating">
            <div class="circular-svg-wrap">
              <svg width="120" height="120" class="circle-svg">
                <circle class="circle-track" cx="60" cy="60" r="50"></circle>
                <circle class="circle-fill-path" id="cPath" cx="60" cy="60" r="50" stroke-dasharray="314.16" stroke-dashoffset="62.83"></circle>
              </svg>
              <!-- Glowing Orbital Dot -->
              <div class="orbital-dot" id="orbitalDot" style="transform: rotate(198deg) translate(50px) rotate(-198deg);"></div>
              <div class="circle-center-text">
                <span class="circle-num" id="cNum">8.0</span>
                <span class="circle-label" id="cLabel">Excellent!</span>
              </div>
            </div>

            <!-- Interaction Controls -->
            <div style="display:flex; gap:10px; margin-top:20px;">
              <button class="trigger-live-btn purple" onclick="adjustRating(-0.5)"><i class="fa-solid fa-minus"></i></button>
              <button class="trigger-live-btn green" onclick="adjustRating(0.5)"><i class="fa-solid fa-plus"></i></button>
            </div>
          </div>
      ...
      <pre class="code-block" id="codeC" style="display:none;"><code>&lt;div class="premium-circular-rating"&gt;
  &lt;svg width="120" height="120" class="circle-svg"&gt;
    &lt;circle class="circle-track" cx="60" cy="60" r="50"&gt;&lt;/circle&gt;
    &lt;circle class="circle-fill-path" cx="60" cy="60" r="50" stroke-dasharray="314.16" stroke-dashoffset="62.83"&gt;&lt;/circle&gt;
  &lt;/svg&gt;
  &lt;div class="orbital-dot"&gt;&lt;/div&gt;
  &lt;div class="circle-center-text"&gt;
    &lt;span class="circle-num"&gt;8.0&lt;/span&gt;
    ...
    <div class="component-card" data-category="stars">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-interactive-hover-ui">
            <div class="interactive-stars-row" id="hoverStars">
              <i class="fa-solid fa-star" data-idx="1" onmouseover="triggerHoverGlow(1)" onclick="setHoverSelect(1)"></i>
              <i class="fa-solid fa-star" data-idx="2" onmouseover="triggerHoverGlow(2)" onclick="setHoverSelect(2)"></i>
              <i class="fa-solid fa-star" data-idx="3" onmouseover="triggerHoverGlow(3)" onclick="setHoverSelect(3)"></i>
              <i class="fa-solid fa-star" data-idx="4" onmouseover="triggerHoverGlow(4)" onclick="setHoverSelect(4)"></i>
              <i class="fa-solid fa-star" data-idx="5" onmouseover="triggerHoverGlow(5)" onclick="setHoverSelect(5)"></i>
            </div>
            <div class="interactive-glow-board" id="glowBoard"></div>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeH', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeH', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeH" style="display:none;"><code>&lt;div class="premium-interactive-hover-ui"&gt;
  &lt;div class="interactive-stars-row"&gt;
    &lt;i class="fa-solid fa-star"&gt;&lt;/i&gt;
    &lt;i class="fa-solid fa-star"&gt;&lt;/i&gt;
  &lt;/div&gt;
  &lt;div class="interactive-glow-board"&gt;&lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="cards">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="glassmorphism-rating-card" id="glassCard">
            <div class="glass-card-header">
              <span class="glass-card-title">Experience Rating</span>
              <span class="glass-card-badge">PRO</span>
            </div>
            <div class="glass-stars-row" id="glassStars">
              <i class="fa-solid fa-star" data-rating="1" onclick="setGlassRating(1)"></i>
              <i class="fa-solid fa-star" data-rating="2" onclick="setGlassRating(2)"></i>
              <i class="fa-solid fa-star" data-rating="3" onclick="setGlassRating(3)"></i>
              <i class="fa-solid fa-star" data-rating="4" onclick="setGlassRating(4)"></i>
              <i class="fa-solid fa-star" data-rating="5" onclick="setGlassRating(5)"></i>
            </div>
            <div class="glass-rating-feedback" id="glassLabel">Tap to Rate Card</div>
          </div>
        </div>
      </div>
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeGCard', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeGCard', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeGCard" style="display:none;"><code>&lt;div class="glassmorphism-rating-card"&gt;
  &lt;div class="glass-card-header"&gt;
    &lt;span class="glass-card-title"&gt;Experience Rating&lt;/span&gt;
  &lt;/div&gt;
  &lt;div class="glass-stars-row"&gt;
    &lt;i class="fa-solid fa-star"&gt;&lt;/i&gt;
    &lt;i class="fa-solid fa-star"&gt;&lt;/i&gt;
  &lt;/div&gt;
  &lt;div class="glass-rating-feedback"&gt;Excellent&lt;/span&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="stars">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="swipe-gesture-rating">
            <div class="gesture-emoji-container" id="gestureEmoji">😐</div>
            <div class="gesture-track-wrapper">
              <input type="range" min="1" max="5" step="1" value="3" class="gesture-slider" id="gestureRange" oninput="updateGestureRating(this.value)">
              <div class="gesture-stars-fill" id="gestureStars">
                <i class="fa-solid fa-star active"></i>
                <i class="fa-solid fa-star active"></i>
                <i class="fa-solid fa-star active"></i>
                <i class="fa-solid fa-star"></i>
            ...
            <span class="gesture-value-label" id="gestureLabel">Neutral — 3.0 / 5.0</span>
          </div>
        </div>
      </div>
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeSwipe', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeSwipe', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeSwipe" style="display:none;"><code>&lt;div class="swipe-gesture-rating"&gt;
  &lt;div class="gesture-emoji-container"&gt;😐&lt;/div&gt;
  &lt;input type="range" min="1" max="5" value="3" class="gesture-slider"&gt;
  &lt;span class="gesture-value-label"&gt;3.0 / 5.0&lt;/span&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="emojis">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="animated-reaction-meter">
            <div class="reaction-display-box" id="reactionDisplay">
              <div class="reaction-avatar" id="reactionAvatar">😐</div>
              <div class="reaction-glowing-ring"></div>
            </div>
            <div class="reaction-selectors">
              <button class="reaction-btn" onclick="triggerReaction(1, '😠', 'angry')">😠</button>
              <button class="reaction-btn" onclick="triggerReaction(2, '😢', 'sad')">😢</button>
              <button class="reaction-btn active" onclick="triggerReaction(3, '😐', 'neutral')">😐</button>
              <button class="reaction-btn" onclick="triggerReaction(4, '🙂', 'happy')">🙂</button>
              <button class="reaction-btn" onclick="triggerReaction(5, '😍', 'excited')">😍</button>
            </div>
            <span class="reaction-status-text" id="reactionLabel">It's Okay!</span>
          </div>
        </div>
      </div>
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeReaction', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeReaction', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeReaction" style="display:none;"><code>&lt;div class="animated-reaction-meter"&gt;
  &lt;div class="reaction-display-box"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="cards">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="multi-criteria-panel">
            <div class="criteria-overall">
              <span class="overall-label">Composite Rating</span>
              <span class="overall-score" id="compositeScore">4.0</span>
            </div>
            <div class="criteria-rows">
              <div class="criteria-row" data-criteria="design">
                <span class="criteria-name">Design</span>
                <div class="criteria-stars" id="cStarsDesign">
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('design', 1)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('design', 2)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('design', 3)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('design', 4)"></i>
                  <i class="fa-solid fa-star" onclick="setCriteriaVal('design', 5)"></i>
                </div>
              </div>
              <div class="criteria-row" data-criteria="perf">
                <span class="criteria-name">Performance</span>
                <div class="criteria-stars" id="cStarsPerf">
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('perf', 1)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('perf', 2)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('perf', 3)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('perf', 4)"></i>
                  <i class="fa-solid fa-star" onclick="setCriteriaVal('perf', 5)"></i>
                </div>
              </div>
              <div class="criteria-row" data-criteria="usability">
                <span class="criteria-name">Usability</span>
                <div class="criteria-stars" id="cStarsUsability">
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('usability', 1)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('usability', 2)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('usability', 3)"></i>
                  <i class="fa-solid fa-star active" onclick="setCriteriaVal('usability', 4)"></i>
                  <i class="fa-solid fa-star" onclick="setCriteriaVal('usability', 5)"></i>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeMulti', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeMulti', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeMulti" style="display:none;"><code>&lt;div class="multi-criteria-panel"&gt;
  &lt;div class="criteria-overall"&gt;
    &lt;span class="overall-score"&gt;4.0&lt;/span&gt;
  &lt;/div&gt;
  &lt;div class="criteria-row"&gt;
    &lt;span&gt;Design&lt;/span&gt;
    &lt;div class="criteria-stars"&gt;&lt;i class="fa-solid fa-star active"&gt;&lt;/i&gt;&lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="stars">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="neon-pulse-star-rating">
            <div class="neon-stars-row" id="neonStars">
              <span class="neon-star-wrapper" onclick="triggerNeonPulse(1)"><i class="fa-regular fa-star" data-neon="1"></i></span>
              <span class="neon-star-wrapper" onclick="triggerNeonPulse(2)"><i class="fa-regular fa-star" data-neon="2"></i></span>
              <span class="neon-star-wrapper" onclick="triggerNeonPulse(3)"><i class="fa-regular fa-star" data-neon="3"></i></span>
              <span class="neon-star-wrapper" onclick="triggerNeonPulse(4)"><i class="fa-regular fa-star" data-neon="4"></i></span>
              <span class="neon-star-wrapper" onclick="triggerNeonPulse(5)"><i class="fa-regular fa-star" data-neon="5"></i></span>
            </div>
            <span class="neon-descriptor" id="neonLabel">Pulse Selected Star</span>
          </div>
        </div>
      </div>
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeNeon', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeNeon', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeNeon" style="display:none;"><code>&lt;div class="neon-pulse-star-rating"&gt;
  &lt;div class="neon-stars-row"&gt;
    &lt;span class="neon-star-wrapper"&gt;&lt;i class="fa-regular fa-star"&gt;&lt;/i&gt;&lt;/span&gt;
  &lt;/div&gt;
  &lt;span class="neon-descriptor"&gt;Good&lt;/span&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="footer-grid">
      ...
      <div class="footer-col brand-col">
        <div class="footer-brand">
          ...
          <span class="footer-brand-text">UIverse</span>
        </div>
        <p class="footer-desc">Premium open-source UI component showroom featuring modern glassmorphism layouts, glowing CSS keyframes, and highly interactive vanilla elements.</p>
      </div>
      ...
      <div class="footer-col">
        <h4>V2 Suites</h4>
        <ul class="footer-links">
          <li><a href="notifications-premium.html"><i class="fa-solid fa-bell"></i> Notifications V2</a></li>
          <li><a href="step-indicators.html"><i class="fa-solid fa-list-check"></i> Steppers</a></li>
          <li><a href="progress-premium.html"><i class="fa-solid fa-bars-progress"></i> Progress V2</a></li>
          <li><a href="ratings-premium.html"><i class="fa-solid fa-star"></i> Ratings V2</a></li>
      ...
      <div class="footer-col newsletter-col">
        ...
        <div class="newsletter-form">
          ...
          <button onclick="subscribeNewsletter(this)"><i class="fa-solid fa-paper-plane"></i></button>
        </div>
      </div>
    </div>
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <ul>
      ...
      <li class="active"><a href="ratings-premium.html"><i class="fa-solid fa-star"></i><span>Ratings V2</span></a></li>
      <li><a href="filters-premium.html"><i class="fa-solid fa-sliders"></i><span>Filters V2</span></a></li>
...
<script>
export default { name: 'RatingsPremium' }
</script>
