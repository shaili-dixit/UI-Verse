    ...
    <>
      ...
      <li>
        ...
        <main className="main-home">
            ...
            <div className="hero-preview">
              ...
              <div className="preview-window">
                ...
                <div className="preview-content">
                  ...
                  <div className="mini-card glass-card-mini">
                    <h3>Glass Layout</h3>
                    <i className="fa-solid fa-layer-group"></i>
                  </div>
      
                  <div className="mini-card neon-card">
          ...
          <section className="featured-section" id="components">
      ...
      ========================================================= */}
              ...
              <div className="form-component-card">
                ...
                <div className="card-top">
                  ...
                  <span className="card-tag tag-new">
                    New
                  </span>
                ...
                <div className="form-preview">
                  ...
                  <div className="task-card">
                    ...
                    <div className="task-item">
                      ...
                      <div className="task-check active"></div>
            ...
            <div className="form-component-card">
              ...
              <div className="form-preview">
                <div className="bento-grid">
                  <div className="bento-item bento-large"><h3>Main Feature</h3><p>Highlight area.</p></div>
                  <div className="bento-item bento-small"><i className="fa-solid fa-bolt"></i></div>
                  <div className="bento-item bento-small"><i className="fa-solid fa-star"></i></div>
                  <div className="bento-item bento-medium"><p>Analytics</p></div>
                </div>
              </div>
            </div>
            ...
            <div className="form-component-card">
              ...
              <div className="form-preview">
                <div className="hover-reveal-card">
                  <div className="reveal-content-front">
                    <h3>Hover Me</h3>
                  </div>
                  <div className="reveal-content-back">
                    <p>Hidden details revealed with smooth animation.</p>
                    <button className="reveal-btn">Action</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="form-component-card">
              ...
              <div className="form-preview">
                <div className="floating-action-card">
                  ...
                  <button className="float-btn">Deploy</button>
                </div>
              </div>
            </div>
