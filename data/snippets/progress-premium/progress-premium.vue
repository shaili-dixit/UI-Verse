...
<div class="main-content">
  ...
  <header class="topbar">
    ...
    <div class="topbar-actions">
      <button class="add-btn" onclick="fillAllProgress()"><i class="fa-solid fa-play"></i> Fill All</button>
      <button class="collection-btn" onclick="resetAllProgress()"><i class="fa-solid fa-rotate-left"></i> Reset All</button>
  ...
  <section class="hero">
    <div class="hero-left">
      <div class="breadcrumb">Home &gt; Progress Indicators</div>
      ...
      <div class="hero-tags">
        <span><i class="fa-solid fa-gauge-high"></i> Fluid Animation</span>
        <span><i class="fa-solid fa-star"></i> High-End Glows</span>
        <span><i class="fa-solid fa-layer-group"></i> Glassmorphic Blurs</span>
      </div>
    </div>

    <!-- Hero Progress Preview Animation -->
    <div class="hero-preview">
      <div class="hero-progress-demo">
        <div class="demo-track">
          <div class="demo-fill"></div>
        </div>
        <span class="demo-label">Processing...</span>
      </div>
    </div>
  </section>
  ...
  <section class="filters">
    <button class="active" onclick="filterCategory('all', this)">All Components</button>
  ...
  <!-- SHOWROOM GRID -->
  <div class="notification-grid" id="progressGrid">

    <!-- 1. LINEAR PROGRESS BAR -->
    <div class="component-card" data-category="linear">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          
          <!-- Interactive Render -->
          <div class="premium-linear-container">
            <div class="premium-linear-bar">
              <div class="linear-track-fill" id="lFill" style="width: 50%;">
                <div class="linear-tooltip" id="lTooltip">50%</div>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex; gap:10px; margin-top:30px;">
            <button class="trigger-live-btn purple" onclick="adjustProgress('linear', -10)"><i class="fa-solid fa-minus"></i> Decrease</button>
            <button class="trigger-live-btn orange" onclick="adjustProgress('linear', 10)"><i class="fa-solid fa-plus"></i> Increase</button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeL', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeL', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeL" style="display:none;"><code>&lt;div class="premium-linear-container"&gt;
  &lt;div class="premium-linear-bar"&gt;
    &lt;div class="linear-track-fill" style="width: 50%;"&gt;
      &lt;div class="linear-tooltip"&gt;50%&lt;/div&gt;
    &lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="circular">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          
          <!-- Interactive Render -->
          <div class="premium-circular-progress">
            <div class="circular-svg-wrap">
              <svg width="120" height="120" class="circle-svg">
                <circle class="circle-track" cx="60" cy="60" r="50"></circle>
                <circle class="circle-fill-path" id="cPath" cx="60" cy="60" r="50" stroke-dasharray="314.16" stroke-dashoffset="157.08"></circle>
              </svg>
              <!-- Glowing Orbital Dot -->
              <div class="orbital-dot" id="orbitalDot" style="transform: rotate(90deg) translate(50px) rotate(-90deg);"></div>
              <div class="circle-center-text">
                <span class="circle-num" id="cNum">50%</span>
              </div>
            </div>

            <!-- Interaction Controls -->
            <div style="display:flex; gap:10px; margin-top:20px;">
              <button class="trigger-live-btn purple" onclick="adjustProgress('circular', -10)"><i class="fa-solid fa-minus"></i></button>
              <button class="trigger-live-btn green" onclick="adjustProgress('circular', 10)"><i class="fa-solid fa-plus"></i></button>
            </div>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeC', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeC', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeC" style="display:none;"><code>&lt;div class="premium-circular-progress"&gt;
  &lt;svg width="120" height="120" class="circle-svg"&gt;
    &lt;circle class="circle-track" cx="60" cy="60" r="50"&gt;&lt;/circle&gt;
    &lt;circle class="circle-fill-path" cx="60" cy="60" r="50" stroke-dasharray="314.16" stroke-dashoffset="157.08"&gt;&lt;/circle&gt;
  &lt;/svg&gt;
  &lt;div class="orbital-dot"&gt;&lt;/div&gt;
  &lt;div class="circle-center-text"&gt;
    &lt;span class="circle-num"&gt;50%&lt;/span&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>

    <!-- 3. GRADIENT PROGRESS LOADER -->
    <div class="component-card" data-category="loaders">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          
          <!-- Interactive Render -->
          <div class="premium-gradient-loader">
            <div class="loader-track">
              <div class="loader-running-gradient" id="gFill" style="width: 0%;"></div>
            </div>
            <div class="loader-meta">
              <span class="loader-status" id="loaderStatus">Ready to load</span>
          ...
          <div style="margin-top:20px;">
            <button class="trigger-live-btn orange" onclick="startSimulatedLoad()"><i class="fa-solid fa-rotate"></i> Simulate Load</button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeG', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeG', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeG" style="display:none;"><code>&lt;div class="premium-gradient-loader"&gt;
  &lt;div class="loader-track"&gt;
    &lt;div class="loader-running-gradient" style="width: 75%;"&gt;&lt;/div&gt;
  &lt;/div&gt;
  &lt;div class="loader-meta"&gt;
    &lt;span class="loader-status"&gt;Loading assets...&lt;/span&gt;
    &lt;span class="loader-pct"&gt;75%&lt;/span&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="cards">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-skill-card" onclick="refillSkills()">
            <div class="skill-row">
              ...
              <div class="skill-bar">
                <div class="skill-fill violet" id="sFill1" style="width: 90%;"></div>
              </div>
            </div>
            ...
            <div class="skill-row">
              ...
              <div class="skill-bar">
                <div class="skill-fill green" id="sFill2" style="width: 85%;"></div>
              </div>
            </div>
            ...
            <div class="skill-row">
              ...
              <div class="skill-bar">
                <div class="skill-fill gold" id="sFill3" style="width: 70%;"></div>
              </div>
            </div>
            
            <span class="skill-card-tip"><i class="fa-solid fa-wand-magic-sparkles"></i> Click Card to Refill</span>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeS', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeS', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeS" style="display:none;"><code>&lt;div class="premium-skill-card"&gt;
  &lt;div class="skill-row"&gt;
    &lt;div class="skill-header"&gt;
      &lt;span&gt;UI / UX Design&lt;/span&gt;
      &lt;span class="skill-val"&gt;90%&lt;/span&gt;
    &lt;/div&gt;
    &lt;div class="skill-bar"&gt;
      &lt;div class="skill-fill violet" style="width: 90%;"&gt;&lt;/div&gt;
    &lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="circular">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-percentage-tracker">
            <div class="tracker-circle">
              <svg width="100" height="100" class="tracker-svg">
                <circle class="tracker-bg" cx="50" cy="50" r="42"></circle>
                <circle class="tracker-fill" id="tPath" cx="50" cy="50" r="42" stroke-dasharray="263.89" stroke-dashoffset="65.97"></circle>
              </svg>
              <div class="tracker-center">
                <span class="tracker-pct" id="trackerNum">75%</span>
              </div>
            </div>
            ...
            <div class="tracker-input-box">
              ...
              <button onclick="applyTrackerTarget()"><i class="fa-solid fa-chevron-right"></i> Set</button>
            </div>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeP', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeP', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeP" style="display:none;"><code>&lt;div class="premium-percentage-tracker"&gt;
  &lt;div class="tracker-circle"&gt;
    &lt;svg width="100" height="100" class="tracker-svg"&gt;
      &lt;circle class="tracker-bg" cx="50" cy="50" r="42"&gt;&lt;/circle&gt;
      &lt;circle class="tracker-fill" cx="50" cy="50" r="42" stroke-dasharray="263.89" stroke-dashoffset="131.95"&gt;&lt;/circle&gt;
    &lt;/svg&gt;
    &lt;div class="tracker-center"&gt;
      &lt;span class="tracker-pct"&gt;50%&lt;/span&gt;
    &lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="linear">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-segmented-progress">
            <div class="segmented-steps" id="segSteps">
              <span class="seg-step active" data-seg="1"></span>
              <span class="seg-step" data-seg="2"></span>
              <span class="seg-step" data-seg="3"></span>
              <span class="seg-step" data-seg="4"></span>
              <span class="seg-step" data-seg="5"></span>
            </div>
            <div class="segmented-subtext">
          ...
          <div style="display:flex; gap:10px; margin-top:25px;">
            <button class="trigger-live-btn purple" onclick="adjustProgress('segmented', -1)"><i class="fa-solid fa-chevron-left"></i> Prev</button>
            <button class="trigger-live-btn orange" onclick="adjustProgress('segmented', 1)">Next <i class="fa-solid fa-chevron-right"></i></button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeSeg', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeSeg', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeSeg" style="display:none;"><code>&lt;div class="premium-segmented-progress"&gt;
  &lt;div class="segmented-steps"&gt;
    &lt;span class="seg-step active"&gt;&lt;/span&gt;
    &lt;span class="seg-step active"&gt;&lt;/span&gt;
    &lt;span class="seg-step"&gt;&lt;/span&gt;
  &lt;/div&gt;
  &lt;div class="segmented-subtext"&gt;
    ...
    <div class="component-card" data-category="loaders">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-wave-progress">
            <div class="wave-tank">
              <svg class="wave-svg" viewBox="0 0 100 100" preserveAspectRatio="none">
                <path class="wave-fill-path" id="waveFill" d="M0,50 C30,45 70,55 100,50 L100,100 L0,100 Z" style="transform: translateY(50%);"></path>
              </svg>
              <div class="wave-center-text">
          ...
          <!-- Interaction Controls -->
          <div style="display:flex; gap:10px; margin-top:20px;">
            <button class="trigger-live-btn purple" onclick="adjustProgress('wave', -10)"><i class="fa-solid fa-minus"></i></button>
            <button class="trigger-live-btn blue" onclick="adjustProgress('wave', 10)"><i class="fa-solid fa-plus"></i></button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeWave', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeWave', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeWave" style="display:none;"><code>&lt;div class="premium-wave-progress"&gt;
  &lt;div class="wave-tank"&gt;
    &lt;svg class="wave-svg" viewBox="0 0 100 100"&gt;
      &lt;path class="wave-fill-path" d="M0,50 C30,45 70,55 100,50 L100,100 L0,100 Z"&gt;&lt;/path&gt;
    &lt;/svg&gt;
    &lt;span class="wave-pct"&gt;50%&lt;/span&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="cards">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-battery-progress">
            <div class="battery-body">
              <div class="battery-fill" id="batFill" style="width: 60%;"></div>
              <div class="battery-nipple"></div>
              <div class="battery-content">
                <i class="fa-solid fa-bolt battery-bolt active" id="batBolt"></i>
                <span id="batPct">60%</span>
              </div>
            </div>
            <div class="battery-status" id="batStatus">Fast Charging (Active)</div>
          </div>

          <!-- Interaction Controls -->
          <div style="display:flex; gap:10px; margin-top:20px;">
            <button class="trigger-live-btn purple" onclick="adjustProgress('battery', -20)"><i class="fa-solid fa-minus"></i></button>
            <button class="trigger-live-btn green" onclick="adjustProgress('battery', 20)"><i class="fa-solid fa-plus"></i></button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeBat', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeBat', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeBat" style="display:none;"><code>&lt;div class="premium-battery-progress"&gt;
  &lt;div class="battery-body"&gt;
    ...
    <div class="component-card" data-category="circular">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-activity-tracker">
            <div class="activity-concentric">
              <!-- Outer Ring: CPU -->
              <svg class="act-ring outer" width="130" height="130">
                <circle class="act-track" cx="65" cy="65" r="55"></circle>
                <circle class="act-fill cpu" id="actFillCPU" cx="65" cy="65" r="55" stroke-dasharray="345.58" stroke-dashoffset="138.23"></circle>
              </svg>
              <!-- Middle Ring: RAM -->
              <svg class="act-ring middle" width="100" height="100">
                <circle class="act-track" cx="50" cy="50" r="40"></circle>
                <circle class="act-fill ram" id="actFillRAM" cx="50" cy="50" r="40" stroke-dasharray="251.33" stroke-dashoffset="75.4"></circle>
              </svg>
              <!-- Inner Ring: Network -->
              <svg class="act-ring inner" width="70" height="70">
                <circle class="act-track" cx="35" cy="35" r="25"></circle>
                <circle class="act-fill net" id="actFillNET" cx="35" cy="35" r="25" stroke-dasharray="157.08" stroke-dashoffset="31.42"></circle>
              </svg>
            </div>
            
            <!-- Statistics logs -->
            <div class="activity-stats">
              <span class="stat-row cpu">CPU: <b id="actValCPU">60%</b></span>
              <span class="stat-row ram">RAM: <b id="actValRAM">70%</b></span>
              <span class="stat-row net">NET: <b id="actValNET">80%</b></span>
            </div>
          </div>

          <!-- Interaction Controls -->
          <div style="margin-top:20px;">
            <button class="trigger-live-btn orange" onclick="jitterActivityTracker()"><i class="fa-solid fa-bolt"></i> Stream Live Loads</button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeAct', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeAct', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeAct" style="display:none;"><code>&lt;div class="premium-activity-tracker"&gt;
  &lt;div class="activity-concentric"&gt;
    &lt;svg class="act-ring"&gt;
      &lt;circle class="act-fill" cx="50" cy="50" r="40" stroke-dasharray="251" stroke-dashoffset="100"&gt;&lt;/circle&gt;
    &lt;/svg&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="cards">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="premium-analytics-chart">
            <h5 class="chart-header">Analytics Throughput</h5>
            
            <div class="chart-row">
              <div class="chart-info">
                <span>Ingestion Stream</span>
                <span class="val" id="chartVal1">65%</span>
              </div>
              <div class="chart-progress">
                <div class="chart-fill magenta" id="chartFill1" style="width: 65%;"></div>
              </div>
            </div>
            ...
            <div class="chart-row">
              <div class="chart-info">
                ...
                <span class="val" id="chartVal2">82%</span>
              </div>
              <div class="chart-progress">
                <div class="chart-fill neon-blue" id="chartFill2" style="width: 82%;"></div>
              </div>
            </div>
            ...
            <div class="chart-row">
              <div class="chart-info">
                ...
                <span class="val" id="chartVal3">45%</span>
              </div>
              <div class="chart-progress">
                <div class="chart-fill amber" id="chartFill3" style="width: 45%;"></div>
              </div>
            </div>
          </div>
          ...
          <!-- Interaction Controls -->
          <div style="margin-top:20px;">
            <button class="trigger-live-btn blue" onclick="startChartSimulate()"><i class="fa-solid fa-chart-line"></i> Pulse Stream</button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeChart', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeChart', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeChart" style="display:none;"><code>&lt;div class="premium-analytics-chart"&gt;
  &lt;div class="chart-row"&gt;
    &lt;div class="chart-info"&gt;
      &lt;span&gt;Ingestion Stream&lt;/span&gt;
    ...
    &lt;/div&gt;
    &lt;div class="chart-progress"&gt;
      &lt;div class="chart-fill magenta" style="width: 65%;"&gt;&lt;/div&gt;
    &lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="progress">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="download-manager" id="downloadManagerPreview">
            <div class="d-item">
              <div class="d-thumb"><i class="fa-solid fa-file-arrow-down"></i></div>
              <div class="d-meta">
                <div class="d-title">assets_bundle.zip</div>
                <div class="d-sub">Downloading • 12.4 MB / 32.1 MB</div>
                <div class="d-progress"><div class="d-fill dwn-fill" style="width:38%"></div></div>
              </div>
              <div class="d-actions"><button onclick="simulateDownloadManager()"><i class="fa-solid fa-play"></i></button></div>
            </div>
            <div class="d-item">
              <div class="d-thumb"><i class="fa-solid fa-file-zipper"></i></div>
              <div class="d-meta">
                <div class="d-title">icons_pack.zip</div>
                <div class="d-sub">Queued • 0 MB</div>
                <div class="d-progress"><div class="d-fill dwn-fill" style="width:0%"></div></div>
              </div>
              <div class="d-actions"><button onclick="simulateDownloadManager()"><i class="fa-solid fa-rotate"></i></button></div>
            </div>
          </div>
        </div>
      </div>
      <div class="card-content">
        <div class="card-top"><h3>Download Manager</h3><span>Progress</span></div>
        <p>Multiple concurrent downloads with per-file progress fills and small inline controls.</p>
        <div class="card-actions">
          <button onclick="toggleCode('code11', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('code11', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="code11" style="display:none;"><code>&lt;div class="d-item"&gt;...&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="loaders">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="indeterminate-strip" id="indStripPreview"></div>
          <div style="margin-top:18px;"><button class="trigger-live-btn purple" onclick="toggleIndeterminateStrip()">Toggle</button></div>
        </div>
      </div>
      <div class="card-content">
        <div class="card-top"><h3>Indeterminate Strip</h3><span>Loaders</span></div>
        <p>A subtle skeleton loader strip used to indicate indeterminate loading states in place of numeric progress.</p>
        <div class="card-actions">
          <button onclick="toggleCode('code12', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('code12', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="code12" style="display:none;"><code>&lt;div class="indeterminate-strip"&gt;...&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="circular">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="donut-meter" id="donutPreview">
            <svg class="donut-svg" width="140" height="140" viewBox="0 0 140 140">
              ...
              <circle class="donut-track" cx="70" cy="70" r="52"></circle>
              <circle class="donut-fill" id="donutFill" cx="70" cy="70" r="52" stroke-dasharray="326.73" stroke-dashoffset="130"></circle>
            </svg>
            <div class="donut-center"><div class="num" id="donutNum">60%</div><div class="muted" style="font-size:12px;color:var(--text-muted);">Overall</div></div>
          </div>
        </div>
      </div>
      <div class="card-content">
        <div class="card-top"><h3>Donut Meter</h3><span>Circular</span></div>
        <p>A decorative donut meter with gradient stroke and center label for compact KPI displays.</p>
        <div class="card-actions">
          <button onclick="toggleCode('code13', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('code13', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="code13" style="display:none;"><code>&lt;svg class="donut-svg"&gt;...&lt;/svg&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="cards">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="transfer-queue" id="transferQueuePreview">
            <div class="t-item">
              <div style="width:36px;text-align:center;color:#a394ff;"><i class="fa-solid fa-cloud-arrow-up"></i></div>
              <div class="t-meta">
                <div style="display:flex;justify-content:space-between"><strong>backup.tar</strong><span class="muted">28%</span></div>
                <div class="t-progress"><div class="t-fill" style="width:28%"></div></div>
              </div>
              <div class="t-actions"><button onclick="simulateTransferQueue()"><i class="fa-solid fa-arrow-up-right-from-square"></i></button></div>
            </div>
            <div class="t-item">
              <div style="width:36px;text-align:center;color:#10b981;"><i class="fa-solid fa-cloud-arrow-down"></i></div>
              <div class="t-meta">
                <div style="display:flex;justify-content:space-between"><strong>db_snapshot.sql</strong><span class="muted">4%</span></div>
                <div class="t-progress"><div class="t-fill" style="width:4%"></div></div>
              </div>
              <div class="t-actions"><button onclick="simulateTransferQueue()"><i class="fa-solid fa-rotate"></i></button></div>
            </div>
          </div>
        </div>
      </div>
      <div class="card-content">
        <div class="card-top"><h3>Transfer Queue</h3><span>Cards</span></div>
        <p>Queue view for file transfers with per-item progress and quick cancel or retry actions.</p>
        <div class="card-actions">
          <button onclick="toggleCode('code14', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('code14', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="code14" style="display:none;"><code>&lt;div class="t-item"&gt;...&lt;/div&gt;</code></pre>
    </div>
    ...
    <div class="component-card" data-category="linear">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="marathon-track" id="marathonPreview">
            <div class="marathon-fill"></div>
          </div>
          <div style="margin-top:18px;"><button class="trigger-live-btn orange" onclick="startMarathon(this)">Start</button></div>
        </div>
      </div>
      <div class="card-content">
        <div class="card-top"><h3>Marathon Progress</h3><span>Linear</span></div>
        <p>A long-running marquee-style progress bar ideal for background syncs and live gradients.</p>
        <div class="card-actions">
          <button onclick="toggleCode('code15', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('code15', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="code15" style="display:none;"><code>&lt;div class="marathon-track"&gt;&lt;div class="marathon-fill"&gt;&lt;/div&gt;&lt;/div&gt;</code></pre>
    </div>
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <ul>
      ...
      <li><a href="notifications-premium.html"><i class="fa-solid fa-bell"></i><span>Notifications V2</span></a></li>
      <li><a href="step-indicators.html"><i class="fa-solid fa-list-check"></i><span>Steppers</span></a></li>
      <li class="active"><a href="progress-premium.html"><i class="fa-solid fa-bars-progress"></i><span>Progress V2</span></a></li>
...
<script>
  ...
  function jitterActivityTracker() {
    ...
    if (activityInterval) {
      ...
      btn.innerHTML = '<i class="fa-solid fa-bolt"></i> Stream Live Loads';
  ...
  function startChartSimulate() {
    ...
    if (chartInterval) {
      ...
      chartInterval = null;
      btn.innerHTML = '<i class="fa-solid fa-chart-line"></i> Pulse Stream';
      btn.classList.remove('active');
      return;
    }

    btn.innerHTML = '<i class="fa-solid fa-pause"></i> Pause Pulse';
    btn.classList.add('active');
  ...
  function resetAllProgress() {
    ...
    if (activityInterval) {
      ...
      if (actBtn) {
        actBtn.innerHTML = '<i class="fa-solid fa-bolt"></i> Stream Live Loads';
    ...
    if (chartInterval) {
      ...
      if (chartBtn) {
        chartBtn.innerHTML = '<i class="fa-solid fa-chart-line"></i> Pulse Stream';
...
<script>
export default { name: 'ProgressPremium' }
</script>
