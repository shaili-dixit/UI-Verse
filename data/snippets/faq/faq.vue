    ...
    <div class="main-content">
      ...
      <div class="page-hero">
        <div class="page-hero-left">
          ...
          <p class="page-desc">Find answers to common questions about UIverse, components, usage, setup, and contributions.</p>
          <div class="page-meta">
            <span class="meta-badge"><i class="fa-solid fa-circle-question"></i> FAQ Helpdesk</span>
            <span class="meta-badge"><i class="fa-solid fa-shield-halved"></i> CSP Secure</span>
          </div>
        </div>
      </div>
      ...
      <section class="faq-section" aria-label="Frequently asked questions">
        ...
        <div class="faq-actions">
          <button type="button" id="expandAllBtn" class="faq-action-btn">Expand all</button>
          <button type="button" id="collapseAllBtn" class="faq-action-btn">Collapse all</button>
        </div>

        <div class="faq-item active">
          <div class="faq-question">
            <h3>
              <button id="faq-question-1" class="faq-question-button" type="button" aria-expanded="true" aria-controls="faq-answer-1">
                What is UIverse?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-1" class="faq-answer" role="region" aria-labelledby="faq-question-1" aria-hidden="false">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-2" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-2">
                Is UIverse free to use?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-2" class="faq-answer" role="region" aria-labelledby="faq-question-2" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-3" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-3">
                Do I need any framework?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-3" class="faq-answer" role="region" aria-labelledby="faq-question-3" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-4" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-4">
                Can I contribute components?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-4" class="faq-answer" role="region" aria-labelledby="faq-question-4" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-5" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-5">
                How do I start using UIverse?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-5" class="faq-answer" role="region" aria-labelledby="faq-question-5" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-6" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-6">
                Does UIverse support responsive design?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-6" class="faq-answer" role="region" aria-labelledby="faq-question-6" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-7" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-7">
                Can I customize the components?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-7" class="faq-answer" role="region" aria-labelledby="faq-question-7" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-8" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-8">
                Is UIverse compatible with frameworks?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-8" class="faq-answer" role="region" aria-labelledby="faq-question-8" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-9" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-9">
                Where can I find documentation?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-9" class="faq-answer" role="region" aria-labelledby="faq-question-9" aria-hidden="true">
            <p>
        ...
        <div class="faq-item">
          <div class="faq-question">
            <h3>
              <button id="faq-question-10" class="faq-question-button" type="button" aria-expanded="false" aria-controls="faq-answer-10">
                Does UIverse provide accessibility support?
                <i class="fa-solid fa-chevron-down faq-question-icon" aria-hidden="true"></i>
              </button>
            </h3>
          </div>
          <div id="faq-answer-10" class="faq-answer" role="region" aria-labelledby="faq-question-10" aria-hidden="true">
            <p>
