...
<main class="main-home">
  ...
  <div class="gl-hero">
    <div class="gl-hero-left">
      ...
      <h1 class="page-title">UIverse Guidelines</h1>
      <p class="page-desc">Everything you need to know — how to use UIverse components in your project, how to contribute your own, and how the design system is structured.</p>
      <div class="gl-toc-pills">
        <a href="#getting-started" class="gl-pill"><i class="fa-solid fa-rocket"></i> Getting Started</a>
        <a href="#design-system"   class="gl-pill"><i class="fa-solid fa-palette"></i> Design System</a>
        <a href="#usage"           class="gl-pill"><i class="fa-solid fa-code"></i> How to Use</a>
        <a href="#contribute"      class="gl-pill"><i class="fa-brands fa-github"></i> Contribute</a>
        <a href="#naming"          class="gl-pill"><i class="fa-solid fa-tag"></i> Naming Rules</a>
        <a href="#accessibility"   class="gl-pill"><i class="fa-solid fa-universal-access"></i> Accessibility</a>
      </div>
    </div>
    <div class="gl-hero-right">
      <div class="gl-stats-grid">
        <div class="gl-stat">
          <span class="gl-stat-num">120+</span>
          <span class="gl-stat-label">Components</span>
        </div>
        <div class="gl-stat">
          <span class="gl-stat-num">10</span>
          <span class="gl-stat-label">Categories</span>
        </div>
        <div class="gl-stat">
          <span class="gl-stat-num">100%</span>
          <span class="gl-stat-label">Free & Open</span>
        </div>
        <div class="gl-stat">
          <span class="gl-stat-num">0</span>
          <span class="gl-stat-label">Dependencies</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="gl-layout">
    ...
    <!-- Sticky TOC -->
    <aside class="gl-toc">
      <p class="gl-toc-heading"><i class="fa-solid fa-list"></i> On this page</p>
      <ul class="gl-toc-list">
        <li><a href="#getting-started" class="gl-toc-link active"><span class="gl-toc-num">01</span> Getting Started</a></li>
        <li><a href="#design-system"   class="gl-toc-link"><span class="gl-toc-num">02</span> Design System</a></li>
        <li><a href="#usage"           class="gl-toc-link"><span class="gl-toc-num">03</span> How to Use</a></li>
        <li><a href="#contribute"      class="gl-toc-link"><span class="gl-toc-num">04</span> Contributing</a></li>
        <li><a href="#naming"          class="gl-toc-link"><span class="gl-toc-num">05</span> Naming Rules</a></li>
        <li><a href="#accessibility"   class="gl-toc-link"><span class="gl-toc-num">06</span> Accessibility</a></li>
        <li><a href="#faq"             class="gl-toc-link"><span class="gl-toc-num">07</span> FAQ</a></li>
      </ul>
    </aside>
    ...
    <div class="gl-content">
      ...
      <!-- ===== 02 DESIGN SYSTEM ===== -->
      <section id="design-system" class="gl-section">
        <div class="gl-section-icon"><i class="fa-solid fa-palette"></i></div>
        <div class="gl-section-body">
          <span class="gl-section-num">02</span>
          <h2>Design System</h2>
          ...
          <!-- Colours -->
          <h3 class="gl-sub">🎨 Brand Colours</h3>
          <div class="gl-colour-grid">
            <div class="gl-colour-swatch" style="background:#eb6835;">
              <span>Accent</span><small>#eb6835</small>
            </div>
            <div class="gl-colour-swatch" style="background:#6c5ce7;">
              <span>Secondary</span><small>#6c5ce7</small>
            </div>
            <div class="gl-colour-swatch" style="background:#00b894;">
              <span>Success</span><small>#00b894</small>
            </div>
            <div class="gl-colour-swatch" style="background:#d63031;">
              <span>Danger</span><small>#d63031</small>
            </div>
            <div class="gl-colour-swatch" style="background:#fdcb6e;color:#333;">
              <span>Warning</span><small>#fdcb6e</small>
            </div>
            <div class="gl-colour-swatch" style="background:#0984e3;">
              <span>Info</span><small>#0984e3</small>
            </div>
            <div class="gl-colour-swatch" style="background:#f5f4f2;color:#333;border:1px solid #e0e0e0;">
              <span>Light BG</span><small>#f5f4f2</small>
            </div>
            <div class="gl-colour-swatch" style="background:#0f0f12;">
              <span>Dark BG</span><small>#0f0f12</small>
            </div>
          </div>

          <!-- Typography -->
          <h3 class="gl-sub">✍️ Typography</h3>
          <div class="gl-type-table">
            <div class="gl-type-row gl-type-header">
              <span>Role</span><span>Font</span><span>Weight</span><span>Usage</span>
            </div>
            <div class="gl-type-row">
              <span><strong>Heading</strong></span>
              <span class="gl-mono">Syne</span>
              <span>700 / 800</span>
              <span>Page titles, card labels, hero text</span>
            </div>
            <div class="gl-type-row">
              <span><strong>Body</strong></span>
              <span class="gl-mono">DM Sans</span>
              <span>400 / 500</span>
              <span>Paragraphs, descriptions, labels</span>
            </div>
            <div class="gl-type-row">
              <span><strong>Code</strong></span>
              <span class="gl-mono">Fira Code / Courier New</span>
              <span>400</span>
          ...
          <!-- Spacing & Radius -->
          <h3 class="gl-sub">📐 Spacing & Border Radius</h3>
          <div class="gl-token-grid">
            <div class="gl-token-card">
              <div class="gl-token-preview" style="border-radius:8px;"></div>
              <code>--radius-sm</code>
              <span>8px — inputs, tags, code</span>
            </div>
            <div class="gl-token-card">
              <div class="gl-token-preview" style="border-radius:14px;"></div>
              <code>--radius-md</code>
              <span>14px — cards, dropdowns</span>
            </div>
            <div class="gl-token-card">
              <div class="gl-token-preview" style="border-radius:20px;"></div>
              <code>--radius-lg</code>
              <span>20px — hero sections, modals</span>
            </div>
            <div class="gl-token-card">
              <div class="gl-token-preview" style="border-radius:999px;"></div>
              <code>999px</code>
              <span>Pills, badges, toggles</span>
            </div>
          </div>

          <div class="gl-callout gl-callout-tip">
            <i class="fa-solid fa-lightbulb"></i>
            <p>Add the UIverse CSS variables to your project's <code class="gl-inline-code">:root</code> and components will automatically adopt your theming when you override them.</p>
          </div>

          <!-- CSS Variables snippet -->
          <h3 class="gl-sub">⚙️ CSS Custom Properties</h3>
          <pre class="gl-code-block"><code>:root {
  /* Brand */
  --accent:       #eb6835;
  --accent-2:     #6c5ce7;
...
body.dark-mode {
  ...
  --text-secondary: #999999;
      ...
      <!-- ===== 03 HOW TO USE ===== -->
      <section id="usage" class="gl-section">
        <div class="gl-section-icon"><i class="fa-solid fa-code"></i></div>
        <div class="gl-section-body">
          <span class="gl-section-num">03</span>
          ...
          <h3 class="gl-sub">📋 Recommended File Structure</h3>
          <pre class="gl-code-block"><code>your-project/
├── index.html
...
└── js/
    └── main.js        ← Paste any interactive JS here</code></pre>
          ...
          <h3 class="gl-sub">🔗 Linking Fonts & Icons</h3>
          <p>UIverse uses Google Fonts and Font Awesome. Add these to your <code class="gl-inline-code">&lt;head&gt;</code>:</p>
          <pre class="gl-code-block"><code>&lt;!-- Fonts --&gt;
...
&lt;link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"&gt;</code></pre>
          ...
          <h3 class="gl-sub">🎨 Customising a Component</h3>
          ...
          <pre class="gl-code-block"><code>/* Override UIverse accent colour to your brand blue */
:root {
  --accent: #3b82f6;
}
...
.my-card .gradient-btn {
  background: linear-gradient(45deg, #3b82f6, #8b5cf6);
          ...
          <h3 class="gl-sub">💡 Dark Mode</h3>
          <p>UIverse dark mode is toggled by adding <code class="gl-inline-code">dark-mode</code> to the <code class="gl-inline-code">&lt;body&gt;</code> element. Persist the preference using localStorage:</p>
          <pre class="gl-code-block"><code>const btn = document.getElementById('themeToggle');
...
if (localStorage.getItem('theme') === 'dark') {
  document.body.classList.add('dark-mode');
          ...
          <div class="gl-callout gl-callout-warning">
      ...
      <!-- ===== 04 CONTRIBUTING ===== -->
      <section id="contribute" class="gl-section">
        <div class="gl-section-icon accent-icon"><i class="fa-brands fa-github"></i></div>
        <div class="gl-section-body">
          <span class="gl-section-num">04</span>
          ...
          <div class="gl-steps">
            ...
            <div class="gl-step">
              ...
              <div class="gl-step-body">
                ...
                <p>Name your branch descriptively: <code class="gl-inline-code">add-modal-component</code> or <code class="gl-inline-code">fix-button-hover</code>.</p>
              </div>
            </div>
            <div class="gl-step">
              <div class="gl-step-num">3</div>
          ...
          <h3 class="gl-sub">📦 Component File Template</h3>
          <p>Every new component page should follow this structure:</p>
          <pre class="gl-code-block"><code>&lt;!-- Component Card structure --&gt;
  ...
  &lt;/div&gt;
    ...
    <div class="usage-grid">
      ...
      <article class="usage-item">
        <h3>Buttons</h3>
<pre class="code-block"><code>&lt;link rel="stylesheet" href="button.css"&gt;

&lt;button class="primary-btn"&gt;Get Started&lt;/button&gt;</code></pre>
      </article>

      <article class="usage-item">
        <h3>Cards</h3>
<pre class="code-block"><code>&lt;link rel="stylesheet" href="cards.css"&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <article class="usage-item">
        <h3>Alerts</h3>
<pre class="code-block"><code>&lt;link rel="stylesheet" href="alerts.css"&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <article class="usage-item">
        <h3>Forms</h3>
<pre class="code-block"><code>&lt;link rel="stylesheet" href="forms.css"&gt;
...
&lt;/form&gt;</code></pre>
      ...
      <article class="usage-item">
        <h3>Inputs</h3>
<pre class="code-block"><code>&lt;link rel="stylesheet" href="input.css"&gt;
...
&lt;input class="preview-input"
  ...
  placeholder="Search components"&gt;</code></pre>
      ...
      <article class="usage-item">
        <h3>Navbar</h3>
<pre class="code-block"><code>&lt;link rel="stylesheet" href="navbar.css"&gt;
...
&lt;/nav&gt;</code></pre>
    ...
    <div class="usage-card usage-note">
      ...
      <!-- ===== 05 NAMING RULES ===== -->
      <section id="naming" class="gl-section">
        <div class="gl-section-icon"><i class="fa-solid fa-tag"></i></div>
        <div class="gl-section-body">
          <span class="gl-section-num">05</span>
          ...
          <div class="gl-rule-list">

            <div class="gl-rule">
              <div class="gl-rule-icon gl-rule-do"><i class="fa-solid fa-check"></i></div>
              <div>
                <h4>CSS Classes — BEM-inspired, kebab-case</h4>
                <div class="gl-do-dont">
                  <div class="gl-do">
                    <span class="gl-badge gl-badge-do">✓ Do</span>
                    <pre class="gl-mini-code">.profile-card { }
.profile-card__avatar { }
.profile-card--featured { }</pre>
                  </div>
                  <div class="gl-dont">
                    <span class="gl-badge gl-badge-dont">✗ Don't</span>
                    <pre class="gl-mini-code">.ProfileCard { }
.profilecard_avatar { }
.FEATURED_CARD { }</pre>
                  </div>
                </div>
            ...
            <div class="gl-rule">
              ...
              <div>
                ...
                <div class="gl-do-dont">
                  <div class="gl-do">
                    <span class="gl-badge gl-badge-do">✓ Do</span>
                    <pre class="gl-mini-code">data-name="gradient button colorful hover"</pre>
                  </div>
                  <div class="gl-dont">
                    <span class="gl-badge gl-badge-dont">✗ Don't</span>
                    <pre class="gl-mini-code">data-name="GradientButton"
            ...
            <div class="gl-rule">
              ...
              <div>
                ...
                <div class="gl-do-dont">
                  <div class="gl-do">
                    <span class="gl-badge gl-badge-do">✓ Do</span>
                    <pre class="gl-mini-code">data-cat="style"
data-cat="animated"
data-cat="dark"</pre>
                  </div>
                  <div class="gl-dont">
                    <span class="gl-badge gl-badge-dont">✗ Don't</span>
                    <pre class="gl-mini-code">data-cat="Dark Theme"
            ...
            <div class="gl-rule">
              ...
              <div>
                ...
                <div class="gl-do-dont">
                  <div class="gl-do">
                    <span class="gl-badge gl-badge-do">✓ Do</span>
                    <pre class="gl-mini-code">navbar-page.css
progress.html
alerts.css</pre>
                  </div>
                  <div class="gl-dont">
                    <span class="gl-badge gl-badge-dont">✗ Don't</span>
                    <pre class="gl-mini-code">NavbarPage.css
Progress Page.html
ALERTS.CSS</pre>
                  </div>
                </div>
            ...
            <div class="gl-rule">
              ...
              <div>
                ...
                <div class="gl-do-dont">
                  <div class="gl-do">
                    <span class="gl-badge gl-badge-do">✓ Do</span>
                    <pre class="gl-mini-code">id="btn1"   ← buttons page
id="al3"    ← alerts page
id="pb7"    ← progress page</pre>
                  </div>
                  <div class="gl-dont">
                    <span class="gl-badge gl-badge-dont">✗ Don't</span>
                    <pre class="gl-mini-code">id="code"
id="myCode1"
id="snippet-for-gradient-button"</pre>
      ...
      <!-- ===== 06 ACCESSIBILITY ===== -->
      <section id="accessibility" class="gl-section">
        <div class="gl-section-icon"><i class="fa-solid fa-universal-access"></i></div>
        <div class="gl-section-body">
          <span class="gl-section-num">06</span>
          <h2>Accessibility</h2>
          ...
          <div class="gl-checklist">
            <div class="gl-check-item">
              <div class="gl-check-dot"><i class="fa-solid fa-check"></i></div>
              <div>
                <h4>Semantic HTML</h4>
                <p>Use the correct element for the job. Buttons should be <code class="gl-inline-code">&lt;button&gt;</code>, not <code class="gl-inline-code">&lt;div&gt;</code>. Links should be <code class="gl-inline-code">&lt;a&gt;</code>.</p>
              </div>
            </div>
            <div class="gl-check-item">
              <div class="gl-check-dot"><i class="fa-solid fa-check"></i></div>
              <div>
                ...
                <p>Icon-only buttons must have <code class="gl-inline-code">aria-label</code>. Toggles and tabs must use the correct <code class="gl-inline-code">role</code> and <code class="gl-inline-code">aria-*</code> attributes.</p>
                <pre class="gl-code-block" style="margin-top:10px;"><code>&lt;!-- Good --&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <div class="gl-check-item">
              ...
              <div>
                ...
                <pre class="gl-code-block" style="margin-top:10px;"><code>/* Good — custom focus ring */
.btn:focus-visible {
...
* { outline: none; } ← Never do this</code></pre>
            ...
            <div class="gl-check-item">
              ...
              <div>
                ...
                <pre class="gl-code-block" style="margin-top:10px;"><code>@media (prefers-reduced-motion: reduce) {
  *, *::before, *::after {
    ...
    transition-duration: 0.01ms !important;
      ...
      <!-- ===== 07 FAQ ===== -->
      <section id="faq" class="gl-section">
        <div class="gl-section-icon"><i class="fa-solid fa-circle-question"></i></div>
        <div class="gl-section-body">
          <span class="gl-section-num">07</span>
          <h2>Frequently Asked Questions</h2>

          <div class="gl-faq-list">

            <div class="gl-faq-item" onclick="toggleFaq(this)">
              <div class="gl-faq-q">
                <span>Is UIverse completely free?</span>
                <i class="fa-solid fa-chevron-down gl-faq-icon"></i>
              </div>
              <div class="gl-faq-a">
            ...
            <div class="gl-faq-item" onclick="toggleFaq(this)">
              ...
              <div class="gl-faq-a">
                <p>Open an issue on <a class="gl-link" href="https://github.com/chinmay1126/UI-Verse" target="_blank">GitHub</a>. Include the component name, a description of the bug, and a screenshot if possible. We aim to respond within 48 hours.</p>
              </div>
            </div>
            ...
            <div class="gl-faq-item" onclick="toggleFaq(this)">
              ...
              <div class="gl-faq-a">
                <p>Check three things: (1) Did you include the CSS as well as the HTML? (2) Are the Font Awesome and Google Fonts CDN links in your <code class="gl-inline-code">&lt;head&gt;</code>? (3) Are there any CSS conflicts with your existing styles? Open your browser dev tools to inspect the element.</p>
              </div>
            </div>
          ...
          <div class="gl-cta">
            <div class="gl-cta-inner">
              ...
              <div class="gl-cta-btns">
                <a href="https://github.com/chinmay1126/UI-Verse" target="_blank" class="gl-cta-btn gl-cta-primary">
                  <i class="fab fa-github"></i> Open an Issue
                </a>
                <a href="contact.html" class="gl-cta-btn gl-cta-outline">
...
<script>
export default { name: 'Documentation' }
</script>
