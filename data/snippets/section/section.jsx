  ...
  return (
    <>
      ...
      <div className="section-card premium-card">
        ...
        <div className="section-icon gradient-red">
          🏢
        </div>
      ...
      <div className="section-card premium-card">
        ...
        <div className="section-icon gradient-gold">
          🎓
        </div>
      ...
      <div className="section-card premium-card">
        ...
        <div className="section-icon gradient-dark">
          🌌
        </div>
      ...
      <div className="section-card premium-card">
        ...
        <div className="section-icon gradient-sky">
          ☁️
        </div>
      ...
      <div className="section-card premium-card">
        ...
        <div className="section-icon gradient-violet">
          📦
        </div>
      ...
      <div className="section-card premium-card">
        ...
        <div className="section-icon gradient-lime">
          🌿
        </div>
