...
&lt;/div&gt;
  ...
  <div class="alert-box alert-confirmation">
    <div>
...
<div class="component-card">
  ...
  <div class="alert-box alert-loading">
    <div>
  ...
  <pre id="a5-loading" class="code-block">
&lt;div class="alert-box alert-loading"&gt;
  &lt;strong&gt;Loading&lt;/strong&gt;
  &lt;p&gt;Uploading your file, please wait…&lt;/p&gt;
  &lt;div class="spinner"&gt;&lt;/div&gt;
&lt;/div&gt;
        ...
        <div class="actions">
          ...
          <div class="featured-actions">
            ...
            <button class="primary-demo-btn">
              Explore Alerts
            </button>

            <button class="secondary-demo-btn">
              Documentation
            </button>
        ...
        <div class="featured-preview">
          ...
          <div class="mini-alert success-mini">
            <i class="fa-solid fa-circle-check"></i>
            Payment successful
          </div>

          <div class="mini-alert warning-mini">
            <i class="fa-solid fa-triangle-exclamation"></i>
            Storage almost full
          </div>

          <div class="mini-alert error-mini">
