...
<div class="main-content">
  ...
  <header class="topbar">
    ...
    <div class="topbar-actions">
      <button class="add-btn" onclick="triggerAllShowcase()"><i class="fa-solid fa-play"></i> Test All</button>
...
function startUploadSimulation() {
  ...
  if (statusIcon) {
    statusIcon.innerHTML = '<i class="fa-solid fa-spinner fa-spin orange"></i>';
  }
  ...
  uploadInterval = setInterval(() => {
    ...
    if (uploadPercent >= 100) {
      ...
      uploadInterval = null;
      if (statusIcon) {
        statusIcon.innerHTML = '<i class="fa-solid fa-circle-check green"></i>';
      }
...
function cancelUploadSimulation() {
  ...
  if (statusIcon) {
    statusIcon.innerHTML = '<i class="fa-solid fa-file-arrow-up float-anim"></i>';
  }
...
function sendChatBubbleMessage() {
  ...
  userMsg.innerHTML = `${text}<span class="msg-time">Just now</span>`;
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      supportMsg.innerHTML = `${randomReply}<span class="msg-time">Just now</span>`;
...
<script>
export default { name: 'NotificationsPremium' }
</script>
