...
<div class="main-content">
  ...
  <header class="topbar">
    ...
    <div class="topbar-actions">
      <button class="add-btn" onclick="advanceAllSteps()"><i class="fa-solid fa-play"></i> Advance All</button>
      <button class="collection-btn" onclick="resetAllSteps()"><i class="fa-solid fa-rotate-left"></i> Reset All</button>
  ...
  <section class="hero">
    <div class="hero-left">
      <div class="breadcrumb">Home &gt; Step Indicators</div>
      ...
      <div class="hero-tags">
        <span><i class="fa-solid fa-bolt"></i> Zero Dependencies</span>
        <span><i class="fa-solid fa-mobile-screen-button"></i> Mobile Responsive</span>
        <span><i class="fa-solid fa-wand-magic-sparkles"></i> Pure CSS Keyframes</span>
      </div>
    </div>

    <!-- Hero Stepper Preview Animation -->
    <div class="hero-preview">
      <div class="hero-stepper-demo">
        <div class="demo-track">
          <div class="demo-fill"></div>
        </div>
        <div class="demo-nodes">
          <div class="demo-node active"><i class="fa-solid fa-check"></i></div>
          <div class="demo-node active"><i class="fa-solid fa-spinner fa-spin"></i></div>
          <div class="demo-node">3</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="filters">
    <button class="active" onclick="filterCategory('all', this)">All Steppers</button>
  ...
  <!-- SHOWROOM GRID -->
  <div class="notification-grid" id="stepperGrid">

    <!-- 1. HORIZONTAL STEP INDICATOR -->
    <div class="component-card" data-category="horizontal">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          
          <!-- Interactive Render -->
          <div class="premium-horizontal-stepper" id="horizontalStepper">
            <div class="stepper-track-bg">
              <div class="stepper-track-fill" id="hFill" style="width: 0%;"></div>
            </div>
          ...
          <div style="display:flex; gap:10px; margin-top:20px;">
            <button class="trigger-live-btn purple" onclick="prevStep('horizontal')"><i class="fa-solid fa-arrow-left"></i> Prev</button>
            <button class="trigger-live-btn orange" onclick="nextStep('horizontal')">Next <i class="fa-solid fa-arrow-right"></i></button>
          </div>
      ...
      <pre class="code-block" id="codeH" style="display:none;"><code>&lt;div class="premium-horizontal-stepper"&gt;
  &lt;div class="stepper-track-bg"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="vertical">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <div class="premium-vertical-stepper">
            <div class="vertical-track">
              <div class="vertical-fill" id="vFill" style="height: 0%;"></div>
            </div>
            
            <div class="vertical-steps">
              <div class="v-step active" onclick="setStep('vertical', 1)" data-vstep="1">
                <div class="v-node">1</div>
                <div class="v-text">
                  <h4>Configure Repository</h4>
                  <p>Initialize workspace guidelines and tokens.</p>
                </div>
              </div>
              <div class="v-step" onclick="setStep('vertical', 2)" data-vstep="2">
              ...
              <div class="v-step" onclick="setStep('vertical', 3)" data-vstep="3">
                <div class="v-node">3</div>
                <div class="v-text">
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeV', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeV', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeV" style="display:none;"><code>&lt;div class="premium-vertical-stepper"&gt;
  &lt;div class="vertical-track"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <!-- 3. CHECKOUT STEPPER -->
    <div class="component-card" data-category="checkout">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          
          <!-- Interactive Render -->
          <div class="premium-checkout-stepper" id="checkoutStepper">
            <div class="checkout-track">
              <div class="checkout-fill" id="cFill" style="width: 0%;"></div>
            </div>
            
            <div class="checkout-steps">
              <div class="c-step active" data-cstep="1">
                <div class="c-badge"><i class="fa-solid fa-truck-fast"></i></div>
                <span class="c-label">Shipping</span>
              </div>
              <div class="c-step" data-cstep="2">
                <div class="c-badge"><i class="fa-solid fa-credit-card"></i></div>
                <span class="c-label">Payment</span>
              </div>
              <div class="c-step" data-cstep="3">
          ...
          <!-- Interaction Controls -->
          <div style="display:flex; gap:10px; margin-top:20px;">
            <button class="trigger-live-btn purple" onclick="prevStep('checkout')"><i class="fa-solid fa-arrow-left"></i> Back</button>
            <button class="trigger-live-btn green" onclick="nextStep('checkout')">Next <i class="fa-solid fa-arrow-right"></i></button>
          </div>
      ...
      <pre class="code-block" id="codeC" style="display:none;"><code>&lt;div class="premium-checkout-stepper"&gt;
  &lt;div class="checkout-track"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="horizontal">
        ...
        <div class="card-interactive-area full-width">
          ...
          <div class="premium-numbered-flow">
            <div class="flow-nodes">
              <div class="flow-node active" onclick="setStep('flow', 1)" data-fstep="1">
                <span class="flow-num">01</span>
                <span class="flow-title">Basics</span>
              </div>
              <div class="flow-node" onclick="setStep('flow', 2)" data-fstep="2">
                <span class="flow-num">02</span>
                <span class="flow-title">Security</span>
              </div>
              <div class="flow-node" onclick="setStep('flow', 3)" data-fstep="3">
                <span class="flow-num">03</span>
                <span class="flow-title">Deploy</span>
              </div>
              
              <!-- Sliding Indicator Underline -->
              <div class="flow-underline" id="fUnderline" style="left: 0%; width: 33.3%;"></div>
            </div>

            <!-- Active Content Block -->
            <div class="flow-content-panel" id="flowPanel">
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeF', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeF', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeF" style="display:none;"><code>&lt;div class="premium-numbered-flow"&gt;
  &lt;div class="flow-nodes"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="animated">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <div class="premium-animated-stepper">
            <div class="svg-ring-container">
              <svg class="progress-ring" width="120" height="120">
                ...
                <circle class="ring-fill" id="svgCircle" cx="60" cy="60" r="50" stroke-dasharray="314.16" stroke-dashoffset="314.16"></circle>
              </svg>
              <div class="ring-content">
                <span class="ring-step-num" id="ringStepNum">1 / 4</span>
                <span class="ring-step-name" id="ringStepLabel">Start</span>
              </div>
            </div>

            <!-- Play/Advance Buttons -->
            <div style="display:flex; gap:10px; margin-top:20px;">
              <button class="trigger-live-btn purple" onclick="toggleAutoPlay(this)"><i class="fa-solid fa-play"></i> Auto Play</button>
              <button class="trigger-live-btn orange" onclick="nextStep('animated')"><i class="fa-solid fa-chevron-right"></i> Advance</button>
            </div>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeA', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeA', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeA" style="display:none;"><code>&lt;div class="premium-animated-stepper"&gt;
  &lt;svg class="progress-ring" width="120" height="120"&gt;
    &lt;circle class="ring-bg" cx="60" cy="60" r="50"&gt;&lt;/circle&gt;
    ...
    <div class="component-card" data-category="animated">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <!-- Interactive Render -->
          <div class="timeline-journey-stepper" id="journeyStepper">
            <!-- Curved path linking nodes -->
            <svg class="journey-track" viewBox="0 0 320 80">
              <path class="journey-track-bg" d="M 20 40 Q 95 10, 160 40 T 300 40" fill="none" stroke="rgba(255,255,255,0.06)" stroke-width="4"></path>
              <path class="journey-track-fill" id="jFill" d="M 20 40 Q 95 10, 160 40 T 300 40" fill="none" stroke="url(#journeyGradient)" stroke-width="4" stroke-dasharray="320" stroke-dashoffset="320"></path>
              <defs>
            ...
            <div class="journey-nodes">
              <div class="journey-node active" data-jstep="1" style="left: 20px; top: 40px;">
                <span class="j-dot"></span>
                <span class="j-label">Discovery</span>
              </div>
              <div class="journey-node" data-jstep="2" style="left: 160px; top: 40px;">
                <span class="j-dot"></span>
                <span class="j-label">Prototype</span>
              </div>
              <div class="journey-node" data-jstep="3" style="left: 300px; top: 40px;">
                <span class="j-dot"></span>
          ...
          <!-- Controls -->
          <div style="display:flex; gap:10px; margin-top:20px;">
            <button class="trigger-live-btn purple" onclick="prevStep('journey')"><i class="fa-solid fa-chevron-left"></i> Prev</button>
            <button class="trigger-live-btn orange" onclick="nextStep('journey')">Next <i class="fa-solid fa-chevron-right"></i></button>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeJ', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeJ', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeJ" style="display:none;"><code>&lt;div class="timeline-journey-stepper"&gt;
  &lt;svg class="journey-track" viewBox="0 0 320 80"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="checkout">
        ...
        <div class="card-interactive-area full-width">
          ...
          <div class="glassmorphism-wizard">
            <div class="wizard-header">
              <span class="wizard-step-tag" id="wizardTag">STEP 1 OF 3</span>
              <h4 id="wizardStepTitle">Identity Profile</h4>
            </div>
            
            <div class="wizard-carousel">
              <div class="wizard-slider" id="wizardSlider" style="transform: translateX(0%);">
                <!-- Page 1 -->
            ...
            <div class="wizard-nav">
              <button class="wizard-btn-prev" onclick="prevStep('wizard')"><i class="fa-solid fa-angle-left"></i> Back</button>
              <button class="wizard-btn-next" onclick="nextStep('wizard')">Continue <i class="fa-solid fa-angle-right"></i></button>
            </div>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeW', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeW', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeW" style="display:none;"><code>&lt;div class="glassmorphism-wizard"&gt;
  &lt;div class="wizard-header"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="animated">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <div class="circular-orbit-stepper">
            <div class="orbit-wheel" id="orbitWheel" style="transform: rotate(0deg);">
              <div class="orbit-ring"></div>
              
              <!-- Orbital Nodes -->
              <div class="orbit-node active" data-ostep="1" onclick="setStep('orbit', 1)" style="top: 0%; left: 50%; transform: translate(-50%, -50%);">
                <i class="fa-solid fa-shield"></i>
              </div>
              <div class="orbit-node" data-ostep="2" onclick="setStep('orbit', 2)" style="top: 75%; left: 93.3%; transform: translate(-50%, -50%);">
                <i class="fa-solid fa-server"></i>
              </div>
              <div class="orbit-node" data-ostep="3" onclick="setStep('orbit', 3)" style="top: 75%; left: 6.7%; transform: translate(-50%, -50%);">
            ...
            <!-- Central Hub Status -->
            <div class="orbit-hub">
              <span class="hub-label" id="hubLabel">SHIELD</span>
              <span class="hub-status" id="hubStatus">Stage 1</span>
            </div>
          </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeO', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeO', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeO" style="display:none;"><code>&lt;div class="circular-orbit-stepper"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="vertical">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          ...
          <div class="expandable-accordion-stepper">
            <!-- Row 1 -->
            <div class="acc-row active" id="accRow-1" onclick="setStep('accordion', 1)">
              <div class="acc-header">
                <div class="acc-indicator">1</div>
                <h4 class="acc-title">Build Infrastructure</h4>
            ...
            <!-- Row 2 -->
            <div class="acc-row" id="accRow-2" onclick="setStep('accordion', 2)">
              <div class="acc-header">
                <div class="acc-indicator">2</div>
                <h4 class="acc-title">Verify Firewalls</h4>
                <i class="fa-solid fa-chevron-down acc-arrow"></i>
              </div>
              <div class="acc-body">
            ...
            <!-- Row 3 -->
            <div class="acc-row" id="accRow-3" onclick="setStep('accordion', 3)">
              <div class="acc-header">
                <div class="acc-indicator">3</div>
                <h4 class="acc-title">Launch Pipeline</h4>
                <i class="fa-solid fa-chevron-down acc-arrow"></i>
              </div>
              <div class="acc-body">
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeAcc', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeAcc', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>

      <pre class="code-block" id="codeAcc" style="display:none;"><code>&lt;div class="expandable-accordion-stepper"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="horizontal">
          ...
          <div class="mobile-swipe-stepper">
            <div class="phone-screen">
              <div class="swipe-carousel">
                <div class="swipe-slider" id="swipeSlider" style="transform: translateX(0%);">
                  <div class="swipe-page">
                    <div class="swipe-icon"><i class="fa-solid fa-user-ninja"></i></div>
                    <h5>User Setup</h5>
                    <p>Enter your profile alias to initialize settings.</p>
                  </div>
                  <div class="swipe-page">
                    <div class="swipe-icon"><i class="fa-solid fa-fingerprint"></i></div>
                    <h5>Bio-Lock</h5>
                    <p>Add fingerprint security protection layers.</p>
                  </div>
                  <div class="swipe-page">
                    <div class="swipe-icon"><i class="fa-solid fa-bell-concierge"></i></div>
                    <h5>Fully Ready</h5>
              ...
              <div class="swipe-footer">
                <button class="swipe-nav-btn" onclick="prevStep('swipe')">&larr;</button>
                <div class="swipe-dots">
                  <span class="swipe-dot active" data-swipe-dot="1"></span>
                  <span class="swipe-dot" data-swipe-dot="2"></span>
                  <span class="swipe-dot" data-swipe-dot="3"></span>
                </div>
                <button class="swipe-nav-btn" onclick="nextStep('swipe')">&rarr;</button>
              </div>
            </div>
          </div>
      ...
      <pre class="code-block" id="codeSwipe" style="display:none;"><code>&lt;div class="mobile-swipe-stepper"&gt;
  &lt;div class="swipe-carousel"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="horizontal">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="premium-dotted-stepper">
            ...
            <div class="dot-step active">
              <div class="dot-icon"><i class="fa-solid fa-credit-card"></i></div>
              <span>Pay</span>
            </div>
            <div class="dot-line"></div>
            <div class="dot-step">
              <div class="dot-icon"><i class="fa-solid fa-box-open"></i></div>
              <span>Done</span>
            </div>
          </div>
        </div>
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeDot', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeDot', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeDot" style="display:none;"><code>&lt;div class="premium-dotted-stepper"&gt;
  &lt;div class="dot-step active"&gt;
    &lt;div class="dot-icon"&gt;&lt;i class="fa-solid fa-cart-shopping"&gt;&lt;/i&gt;&lt;/div&gt;
    &lt;span&gt;Cart&lt;/span&gt;
  &lt;/div&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="vertical">
      <div class="card-preview">
        <div class="card-interactive-area full-width">
          <div class="premium-text-stepper">
            <div class="text-step completed">
              <span class="t-step-num">01</span>
              <span class="t-step-label">Account Setup</span>
            </div>
            ...
            <div class="text-step">
              <span class="t-step-num">03</span>
              <span class="t-step-label">Verification</span>
            </div>
          </div>
        </div>
      </div>
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeText', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeText', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeText" style="display:none;"><code>&lt;div class="premium-text-stepper"&gt;
  &lt;div class="text-step active"&gt;
    &lt;span class="t-step-num"&gt;02&lt;/span&gt;
    &lt;span class="t-step-label"&gt;Profile Details&lt;/span&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="horizontal">
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeCardStep', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeCardStep', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeCardStep" style="display:none;"><code>&lt;div class="premium-card-stepper"&gt;
  &lt;div class="card-step active"&gt;
    &lt;i class="fa-solid fa-pen-nib"&gt;&lt;/i&gt;
    &lt;span&gt;Design&lt;/span&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="animated">
      ...
      <pre class="code-block" id="codeNeon" style="display:none;"><code>&lt;div class="premium-neon-stepper"&gt;
  &lt;div class="neon-track"&gt;
    &lt;div class="neon-fill" style="width: 50%;"&gt;&lt;/div&gt;
  &lt;/div&gt;
  &lt;div class="neon-nodes"&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <div class="component-card" data-category="vertical">
      ...
      <div class="card-content">
        ...
        <div class="card-actions">
          <button onclick="toggleCode('codeTimeline', this)"><i class="fa-solid fa-code"></i> View Code</button>
          <button onclick="copyCode('codeTimeline', this)"><i class="fa-solid fa-copy"></i> Copy HTML</button>
        </div>
      </div>
      <pre class="code-block" id="codeTimeline" style="display:none;"><code>&lt;div class="premium-timeline-stepper"&gt;
  &lt;div class="timeline-step active"&gt;
    &lt;div class="t-dot"&gt;&lt;/div&gt;
    &lt;div class="t-content"&gt;
      &lt;h5&gt;Processing&lt;/h5&gt;
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <ul>
      ...
      <li class="active"><a href="step-indicators.html"><i class="fa-solid fa-list-check"></i><span>Steppers</span></a></li>
...
<script>
  ...
  function updateHorizontalUI() {
    ...
    nodes.forEach(node => {
      ...
      if (nodeStep < step) {
        ...
        node.querySelector('.node-icon').innerHTML = '<i class="fa-solid fa-check"></i>';
  ...
  function updateVerticalUI() {
    ...
    steps.forEach(s => {
      ...
      if (vstep < step) {
        ...
        s.querySelector('.v-node').innerHTML = '<i class="fa-solid fa-check"></i>';
      } else if (vstep === step) {
  ...
  function resetAllSteps() {
    ...
    if (autoPlayInterval) {
      clearInterval(autoPlayInterval);
      autoPlayInterval = null;
      document.querySelector('[onclick="toggleAutoPlay(this)"]').innerHTML = '<i class="fa-solid fa-play"></i> Auto Play';
    }
  }
...
<script>
export default { name: 'StepIndicators' }
</script>
