      ...
      <div class="hero-flip-container">
        <div class="hero-flip-inner">
          ...
          <div class="hero-flip-front">
            ...
            <div class="flip-hint"><i class="fa-solid fa-arrows-spin"></i> Hover to Flip</div>
          </div>
          <!-- Back -->
...
<li>
  ...
  <section class="flip-grid">
        ...
        <div class="glass-flip-card">
          <div class="glass-flip-inner">
            <div class="glass-flip-front">
              <div class="glass-avatar"><i class="fa-solid fa-user-shield"></i></div>
              <h4>Alex Rivera</h4>
              <p>Security Officer</p>
            </div>
            <div class="glass-flip-back">
              <h5>Access Level</h5>
              <div class="access-badge">Admin</div>
        ...
        <div class="product-flip-card">
          <div class="product-flip-inner">
            <div class="product-flip-front">
              <div class="product-icon"><i class="fa-solid fa-headphones-simple"></i></div>
              <h4>Pro Sound X</h4>
        ...
        <div class="team-flip-card">
          <div class="team-flip-inner">
            ...
            <div class="team-flip-back">
              ...
              <p class="bio-snippet">Pioneering telemetry UI components.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="pricing-flip-card">
          <div class="pricing-flip-inner">
            <div class="pricing-flip-front">
              <span class="plan-badge">PRO</span>
              <h4>Enterprise Tier</h4>
              <h3 class="plan-price">$49/mo</h3>
            </div>
            <div class="pricing-flip-back">
              ...
              <button class="upgrade-btn">Get Started</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="neon-flip-card">
          <div class="neon-flip-inner">
            <div class="neon-flip-front">
              <div class="neon-icon"><i class="fa-solid fa-bolt-lightning"></i></div>
              <h4>Holo Matrix</h4>
              <span class="neon-tag">ACTIVE</span>
            </div>
            <div class="neon-flip-back">
              <h5>Core Diagnostics</h5>
              <div class="diagnostics">
                <span>Shield: 98%</span>
                <span>Core: Stable</span>
              </div>
              <button class="neon-action">Infiltrate</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="recipe-flip-card">
          <div class="recipe-flip-inner">
            <div class="recipe-flip-front">
              <div class="recipe-icon"><i class="fa-solid fa-pizza-slice"></i></div>
              <h4>Artisan Pizza</h4>
              <div class="recipe-meta">
                <span><i class="fa-solid fa-clock"></i> 45m</span>
                <span><i class="fa-solid fa-fire"></i> 320 cal</span>
              </div>
            </div>
            <div class="recipe-flip-back">
              <h5>Ingredients</h5>
              <ul>
                <li>Flour & Yeast</li>
              ...
              <button class="cook-btn">View Recipe</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="weather-flip-card">
          <div class="weather-flip-inner">
            <div class="weather-flip-front">
              <i class="fa-solid fa-cloud-sun weather-icon"></i>
              <h2>72°F</h2>
              <p>Partly Cloudy</p>
            </div>
            <div class="weather-flip-back">
              <h5>Forecast</h5>
              <div class="forecast-row"><span>Mon</span> <span>74°</span></div>
              <div class="forecast-row"><span>Tue</span> <span>70°</span></div>
              <div class="forecast-row"><span>Wed</span> <span>68°</span></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="crypto-flip-card">
          <div class="crypto-flip-inner">
            <div class="crypto-flip-front">
              <div class="crypto-header">
                <i class="fa-brands fa-bitcoin"></i>
                <span>BTC</span>
              </div>
              <h3>$64,230.00</h3>
              <span class="trend up"><i class="fa-solid fa-arrow-trend-up"></i> +2.4%</span>
            </div>
            <div class="crypto-flip-back">
              <h5>Market Stats</h5>
              <div class="stat-grid">
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="social-flip-card">
          <div class="social-flip-inner">
            <div class="social-flip-front">
              <div class="social-avatar"><i class="fa-brands fa-instagram"></i></div>
              <h4>Design Studio</h4>
              <p>Creative Agency</p>
            </div>
            <div class="social-flip-back">
              <h5>Followers</h5>
        ...
        <div class="team-flip-card">
          <div class="team-flip-inner">
            ...
            <div class="team-flip-back">
              ...
              <p class="bio-text">Expert in design systems</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="product-flip-card">
          <div class="product-flip-inner">
            <div class="product-flip-front">
              <div class="product-icon"><i class="fa-solid fa-laptop"></i></div>
              <h4>Pro Monitor</h4>
    ...
    <div class="component-card">
      <div class="card-preview">
        <div class="smart-flip-card">
          <div class="smart-flip-inner">
            <div class="smart-flip-front">
              <div class="smart-icon"><i class="fa-solid fa-lightbulb"></i></div>
              <h4>Living Room</h4>
              <p>23°C · Active</p>
            </div>
            <div class="smart-flip-back">
              <h5>Devices</h5>
              ...
              <button class="smart-btn">Control</button>
            </div>
          </div>
        </div>
      </div>
