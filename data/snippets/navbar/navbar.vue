...
<div class="component-card" data-name="floating navbar modern glass" data-cat="glass">

  <div class="card-top">
    <span class="card-label">Floating Navbar</span>
...
<div class="component-card" data-name="neon navbar futuristic dark glow" data-cat="dark">

  <div class="card-top">
    <span class="card-label">Neon Navbar</span>
    <span class="card-tag tag-popular">Neon</span>
  </div>

  <div class="nav-card-preview dark-preview">

    <nav class="demo-nav-neon">

      <span class="dnav-brand neon-brand">
        UIverse
      </span>
  ...
  <pre id="c10" class="code-block"><code>&lt;nav class="navbar-neon"&gt;
...
.navbar-center a:hover { color: #eb6835; }</code></pre>
    ...
    <!-- Transparent Navbar -->
<div class="component-card" data-name="transparent navbar modern" data-cat="transparent">
  <div class="card-top">
    <span class="card-label">Transparent Navbar</span>
    <span class="card-tag tag-modern">Modern</span>
  </div>
  <div class="nav-card-preview">
    <nav class="demo-nav-transparent">
      <span class="dnav-brand">UIverse</span>
      <div class="dnav-links">
        <a href="#">Home</a>
        <a href="#">Features</a>
  ...
  <p class="card-desc">A sleek transparent navbar with a blurred background effect, ideal for landing pages and modern designs.</p>
  <div class="actions">
  ...
  <pre id="c2" class="code-block"><code>&lt;nav class="navbar-transparent"&gt;
  &lt;span class="brand"&gt;UIverse&lt;/span&gt;
  &lt;div class="links"&gt;
    &lt;a href="#"&gt;Home&lt;/a&gt;
    &lt;a href="#"&gt;Features&lt;/a&gt;
